    ...
    <main className="overflow-hidden bg-white text-slate-950 dark:bg-[#08090c] dark:text-white">
      ...
      <section className="gradient-grid relative px-6 pb-24 pt-36">
        ...
        <div className="relative mx-auto max-w-7xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-300">ExtensionForge combines an AI prompt builder, authentication screens, project dashboard, Supabase project saving, OpenAI generation, icons, background and content scripts, and ZIP downloads.</p>
